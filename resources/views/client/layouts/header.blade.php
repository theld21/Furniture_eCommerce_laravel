...
<<<<<<< HEAD
                                    ...
                                    <li class="active has-dropdown"><a href="{{ route('client.product.index') }}">Product</a>
                                        <ul class="submenu transition-3">
                                            <li><a href="{{ route('client.product.detail', ['product'=>3]) }}">Desk</a></li>
                                            <li><a href="{{ route('client.product.detail', ['product'=>3]) }}">Chair</a></li>
                                            <li><a href="{{ route('client.product.detail', ['product'=>3]) }}">Shelf</a></li>
                                            <li><a href="{{ route('client.product.detail', ['product'=>3]) }}">Bed</a></li>
=======
